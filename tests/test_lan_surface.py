...
def test_lan_only_exposes_token_protected_phone_surfaces():
    ...
    assert lan_request_allowed("192.168.1.50", "/setup.html") is True
    assert lan_request_allowed("192.168.1.50", "/css/setup.css") is True
    assert lan_request_allowed("192.168.1.50", "/js/setup.js") is True
    assert lan_request_allowed("192.168.1.50", "/assets/piccie-wordmark.svg") is True
    assert lan_request_allowed("192.168.1.50", "/api/setup/status") is True
